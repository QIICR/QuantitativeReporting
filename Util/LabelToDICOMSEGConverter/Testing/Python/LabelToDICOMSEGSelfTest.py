...
#
# LabelToDICOMSEGSelfTest
#

class LabelToDICOMSEGSelfTest:
  def __init__(self, parent):
    parent.title = "LabelToDICOMSEGSelfTest" # TODO make this more human readable by adding spaces
...
""" # replace with organization, grant and thanks.
    ...
    try:
      ...
      slicer.selfTests = {}
    slicer.selfTests['LabelToDICOMSEGSelfTest'] = self.runTest
    print slicer.selfTests

  def runTest(self):
    tester = LabelToDICOMSEGSelfTestTest()
    tester.runTest()

#
# qLabelToDICOMSEGSelfTestWidget
#
...
class LabelToDICOMSEGSelfTestWidget:
  ...
  def setup(self):
    ...
    self.reloadButton.name = "LabelToDICOMSEGSelfTest Reload"
    ...
    # test buttons
    tests = ( ("LabelToDICOMSEG test 1",self.onReportingTest1),)
  ...
  def onReload(self,moduleName="LabelToDICOMSEGSelfTest"):
  ...
  def onReloadAndTest(self,moduleName="LabelToDICOMSEGSelfTest"):
    self.onReload()
...
#
# LabelToDICOMSEGSelfTestLogic
#

class LabelToDICOMSEGSelfTestLogic:
...
class LabelToDICOMSEGSelfTestTest(unittest.TestCase):
  """
  ...
  def runTest(self):
    ...
    """
    self.setUp()
    self.test_LabelToDICOMSEGRoundTrip()
    '''
  ...
  def test_LabelToDICOMSEGRoundTrip(self):
    ...
    reportingTempDir = slicer.app.temporaryPath+'/LabelToDICOMSEG'
