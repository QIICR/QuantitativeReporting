...
#ifndef __qMRMLReportingTreeView_h
#define __qMRMLReportingTreeView_h
...
public:
  ...
  qMRMLReportingTreeView(QWidget *parent=0);
  virtual ~qMRMLReportingTreeView();
...
protected:
  QScopedPointer<qMRMLReportingTreeViewPrivate> d_ptr;
...
private:
  Q_DECLARE_PRIVATE(qMRMLReportingTreeView);
  Q_DISABLE_COPY(qMRMLReportingTreeView);
};

// --------------------------------------------------------------------------
void qMRMLReportingTreeView::setShowHidden(bool enable)
{
  this->sortFilterProxyModel()->setShowHidden(enable);
}

// --------------------------------------------------------------------------
bool qMRMLReportingTreeView::showHidden()const
{
