...
class DICOMM3DPluginBase(DICOMPlugin):
  """
  ...
  def __init__(self):
    super(DICOMM3DPluginBase, self).__init__()
    self.tags['seriesInstanceUID'] = "0020,000E"
    self.tags['modality'] = "0008,0060"
    self.tags['instanceUID'] = "0008,0018"
    self.tags['EncapsulatedDocument'] = "0042,0011"
    self.tags['EncapsulatedDocumentLength'] = "0042,0015"
  ...
  def addReferences(self, loadable):
    ...
    self._addEncapsulatedDocument(loadable, dcm)
    self._addEncapsulatedDocumentLength(loadable, dcm)
    loadable.referencedInstanceUIDs = list(set(loadable.referencedInstanceUIDs))
  
  def _addEncapsulatedDocument(self, loadable, dcm):
    loadable.EncapsulatedDocument = dcm.EncapsulatedDocument
  
  def _addEncapsulatedDocumentLength(self, loadable, dcm):
    loadable.EncapsulatedDocumentLength = dcm.EncapsulatedDocumentLength
